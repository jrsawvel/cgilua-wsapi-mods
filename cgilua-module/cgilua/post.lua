...
return {
	parsedata = function (defs)
		...
		elseif strfind (contenttype, "application/xml", 1, true) or strfind (contenttype, "text/xml", 1, true) or strfind (contenttype, "text/plain", 1, true) or strfind (contenttype, "application/json", 1, true) then -- jrs - march 2018 - added application/json support
