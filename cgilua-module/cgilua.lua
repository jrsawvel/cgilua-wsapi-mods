...
-- jrs - March 2018 - permit setting the returned status code
function M.jrStatus(rcode)
    SAPI.Response.jrStatus(rcode)
 end
...
local function getparams ()
	...
	M.POST = {}
       -- jrs - april 2018 - added support for the PUT request
